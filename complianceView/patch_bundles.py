...
P13_MX_TD_NEW    = '.cv-ov-mx td{padding:5px 8px;border:1px solid #e2e8f0 !important;text-align:center;font-weight:600;font-size:12px;background:#fff !important;color:#0f172a}'
P13_MX_TD_MARKER = '.cv-ov-mx td{padding:5px 8px;border:1px solid #e2e8f0 !important'
